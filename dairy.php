...
<html>
    <head>
        <title>Group 5's Recipe Shop - Dairy</title>
    ...
    <body>
        ...
        <div class="tab">
            ...
            <button class="section active" onclick="window.location.href = 'dairy.php'">Dairy</button>
        ...
        $sql = "SELECT * FROM items where productType = 'Dairy';";
