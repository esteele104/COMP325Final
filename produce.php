...
<html>
    <head>
        <title>Group 5's Recipe Shop - Produce</title>
    ...
    <body>
        ...
        <div class="tab">
            <button class="section active" onclick="window.location.href ='produce.php'">Produce</button>
        ...
        $sql = "SELECT * FROM items where productType = 'Produce';";
