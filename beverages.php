...
<html>
    <head>
        <title>Group 5's Recipe Shop - Beverages</title>
    ...
    <body>
        ...
        <div class="tab">
            ...
            <button class="section active" onclick="window.location.href = 'beverages.php'">Beverages</button>
            <button class="section" onclick="window.location.href = 'more.php'">More</button>   
        </div>
        
        <?php
        
        $sql = "SELECT * FROM items where productType = 'Beverage';";
